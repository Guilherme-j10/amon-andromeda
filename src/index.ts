...
(async () => {
  ...
  try {
    ...
    //console.log(JSON.stringify((await clientOne.sendSimpleMessage('Vai curitintians', '5511930224168')), undefined, 2))
    ...
    //console.log(JSON.stringify((await clientOne.sendAudioMedia(path.resolve(__dirname, '..', 'media', 'music.mp3'), '5511958493949', false)), undefined, 2));
